...
function Home() {
    ...
    : null
      ...
      <hr />
      <p>{selects}</p>
      <button onClick={()=>{navigate('/2001')}}>어</button>
      <button onClick={()=>{navigate('/2009')}}>디</button>
      <button onClick={()=>{navigate('/2017')}}>로</button>
      <button onClick={()=>{navigate('/2019')}}>든</button>
      <button onClick={()=>{navigate('/2022')}}>문</button>
    </div>
    )
